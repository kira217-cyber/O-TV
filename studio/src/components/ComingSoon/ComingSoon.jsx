...
const ComingSoon = ({ title, description }) => {
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-7xl flex-col items-center justify-center rounded-[28px] border border-[#f59e0b]/20 bg-white/[0.04] p-10 text-center shadow-2xl shadow-black/30 backdrop-blur-xl">
