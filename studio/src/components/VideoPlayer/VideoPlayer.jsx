...
const VideoPlayer = ({ src, poster, title }) => {
  ...
  return (
    <div
      ...
      className="group relative aspect-video w-full overflow-hidden rounded-[28px] border border-[#f59e0b]/20 bg-black shadow-2xl shadow-black/40"
    >
      <video
        ref={videoRef}
        src={src}
      ...
      {!playing && (
        ...
        >
          <span className="flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-[#fde68a] via-[#f59e0b] to-[#b45309] shadow-[0_0_50px_rgba(245,158,11,0.5)] transition group-hover:scale-110">
      ...
      >
        <input
          ...
          value={current}
          onChange={handleSeek}
          className="h-1.5 w-full cursor-pointer appearance-none rounded-full bg-white/25 accent-[#f59e0b]"
        />
        ...
        <div className="mt-2 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <button
              type="button"
              onClick={togglePlay}
              className="cursor-pointer text-white transition hover:text-[#f59e0b]"
            >
              {playing ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="hidden h-1 w-20 cursor-pointer appearance-none rounded-full bg-white/25 accent-[#f59e0b] sm:block"
              />
            </div>
