...
const ContactUs = () => (
  <StaticPage title="Contact Us" subtitle="We're happy to help.">
    <p>
      Have a question about your account, a video, or Pipra-TV in general? Reach
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <a
        href="mailto:support@pipratv.com"
      ...
      >
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-slate-400">support@pipratv.com</p>
        </div>
      </a>
    ...
    <section>
      ...
      <div className="mt-3 flex items-center gap-3">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          aria-label="Pipra-TV on Facebook"
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          aria-label="Pipra-TV on YouTube"
