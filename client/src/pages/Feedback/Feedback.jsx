...
const Feedback = () => (
  <StaticPage
    title="Feedback"
    subtitle="Help us make O-TV better."
  >
    <div className="flex items-start gap-4 rounded-2xl border border-[#16d6dc]/20 bg-[#16d6dc]/[0.06] p-5">
      ...
      <p>
        We build O-TV around what our viewers and creators actually need.
    ...
    <section>
      ...
      <ul className="mt-2 list-disc space-y-1 pl-5">
        <li>Features you wish O-TV had, and why they'd matter to you.</li>
